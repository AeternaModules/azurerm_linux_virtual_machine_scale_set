output "linux_virtual_machine_scale_sets_id" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.id if v.id != null && length(v.id) > 0 }
}
output "linux_virtual_machine_scale_sets_additional_capabilities" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => one(v.additional_capabilities) if v.additional_capabilities != null && length(v.additional_capabilities) > 0 }
}
output "linux_virtual_machine_scale_sets_admin_password" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.admin_password if v.admin_password != null && length(v.admin_password) > 0 }
  sensitive   = true
}
output "linux_virtual_machine_scale_sets_admin_ssh_key" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.admin_ssh_key if v.admin_ssh_key != null && length(v.admin_ssh_key) > 0 }
}
output "linux_virtual_machine_scale_sets_admin_username" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.admin_username if v.admin_username != null && length(v.admin_username) > 0 }
}
output "linux_virtual_machine_scale_sets_automatic_instance_repair" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => one(v.automatic_instance_repair) if v.automatic_instance_repair != null && length(v.automatic_instance_repair) > 0 }
}
output "linux_virtual_machine_scale_sets_automatic_os_upgrade_policy" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => one(v.automatic_os_upgrade_policy) if v.automatic_os_upgrade_policy != null && length(v.automatic_os_upgrade_policy) > 0 }
}
output "linux_virtual_machine_scale_sets_boot_diagnostics" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => one(v.boot_diagnostics) if v.boot_diagnostics != null && length(v.boot_diagnostics) > 0 }
}
output "linux_virtual_machine_scale_sets_capacity_reservation_group_id" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.capacity_reservation_group_id if v.capacity_reservation_group_id != null && length(v.capacity_reservation_group_id) > 0 }
}
output "linux_virtual_machine_scale_sets_computer_name_prefix" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.computer_name_prefix if v.computer_name_prefix != null && length(v.computer_name_prefix) > 0 }
}
output "linux_virtual_machine_scale_sets_custom_data" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.custom_data if v.custom_data != null && length(v.custom_data) > 0 }
  sensitive   = true
}
output "linux_virtual_machine_scale_sets_data_disk" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.data_disk if v.data_disk != null && length(v.data_disk) > 0 }
}
output "linux_virtual_machine_scale_sets_disable_password_authentication" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.disable_password_authentication if v.disable_password_authentication != null }
}
output "linux_virtual_machine_scale_sets_do_not_run_extensions_on_overprovisioned_machines" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.do_not_run_extensions_on_overprovisioned_machines if v.do_not_run_extensions_on_overprovisioned_machines != null }
}
output "linux_virtual_machine_scale_sets_edge_zone" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.edge_zone if v.edge_zone != null && length(v.edge_zone) > 0 }
}
output "linux_virtual_machine_scale_sets_encryption_at_host_enabled" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.encryption_at_host_enabled if v.encryption_at_host_enabled != null }
}
output "linux_virtual_machine_scale_sets_eviction_policy" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.eviction_policy if v.eviction_policy != null && length(v.eviction_policy) > 0 }
}
output "linux_virtual_machine_scale_sets_extension" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.extension if v.extension != null && length(v.extension) > 0 }
  sensitive   = true
}
output "linux_virtual_machine_scale_sets_extension_operations_enabled" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.extension_operations_enabled if v.extension_operations_enabled != null }
}
output "linux_virtual_machine_scale_sets_extensions_time_budget" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.extensions_time_budget if v.extensions_time_budget != null && length(v.extensions_time_budget) > 0 }
}
output "linux_virtual_machine_scale_sets_gallery_application" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.gallery_application if v.gallery_application != null && length(v.gallery_application) > 0 }
}
output "linux_virtual_machine_scale_sets_health_probe_id" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.health_probe_id if v.health_probe_id != null && length(v.health_probe_id) > 0 }
}
output "linux_virtual_machine_scale_sets_host_group_id" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.host_group_id if v.host_group_id != null && length(v.host_group_id) > 0 }
}
output "linux_virtual_machine_scale_sets_identity" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => one(v.identity) if v.identity != null && length(v.identity) > 0 }
}
output "linux_virtual_machine_scale_sets_instances" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.instances if v.instances != null }
}
output "linux_virtual_machine_scale_sets_location" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.location if v.location != null && length(v.location) > 0 }
}
output "linux_virtual_machine_scale_sets_max_bid_price" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.max_bid_price if v.max_bid_price != null }
}
output "linux_virtual_machine_scale_sets_name" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.name if v.name != null && length(v.name) > 0 }
}
output "linux_virtual_machine_scale_sets_network_interface" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.network_interface if v.network_interface != null && length(v.network_interface) > 0 }
}
output "linux_virtual_machine_scale_sets_os_disk" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => one(v.os_disk) if v.os_disk != null && length(v.os_disk) > 0 }
}
output "linux_virtual_machine_scale_sets_overprovision" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.overprovision if v.overprovision != null }
}
output "linux_virtual_machine_scale_sets_plan" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => one(v.plan) if v.plan != null && length(v.plan) > 0 }
}
output "linux_virtual_machine_scale_sets_platform_fault_domain_count" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.platform_fault_domain_count if v.platform_fault_domain_count != null }
}
output "linux_virtual_machine_scale_sets_priority" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.priority if v.priority != null && length(v.priority) > 0 }
}
output "linux_virtual_machine_scale_sets_provision_vm_agent" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.provision_vm_agent if v.provision_vm_agent != null }
}
output "linux_virtual_machine_scale_sets_proximity_placement_group_id" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.proximity_placement_group_id if v.proximity_placement_group_id != null && length(v.proximity_placement_group_id) > 0 }
}
output "linux_virtual_machine_scale_sets_resilient_vm_creation_enabled" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.resilient_vm_creation_enabled if v.resilient_vm_creation_enabled != null }
}
output "linux_virtual_machine_scale_sets_resilient_vm_deletion_enabled" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.resilient_vm_deletion_enabled if v.resilient_vm_deletion_enabled != null }
}
output "linux_virtual_machine_scale_sets_resource_group_name" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.resource_group_name if v.resource_group_name != null && length(v.resource_group_name) > 0 }
}
output "linux_virtual_machine_scale_sets_rolling_upgrade_policy" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => one(v.rolling_upgrade_policy) if v.rolling_upgrade_policy != null && length(v.rolling_upgrade_policy) > 0 }
}
output "linux_virtual_machine_scale_sets_scale_in" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => one(v.scale_in) if v.scale_in != null && length(v.scale_in) > 0 }
}
output "linux_virtual_machine_scale_sets_secret" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.secret if v.secret != null && length(v.secret) > 0 }
}
output "linux_virtual_machine_scale_sets_secure_boot_enabled" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.secure_boot_enabled if v.secure_boot_enabled != null }
}
output "linux_virtual_machine_scale_sets_single_placement_group" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.single_placement_group if v.single_placement_group != null }
}
output "linux_virtual_machine_scale_sets_sku" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.sku if v.sku != null && length(v.sku) > 0 }
}
output "linux_virtual_machine_scale_sets_source_image_id" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.source_image_id if v.source_image_id != null && length(v.source_image_id) > 0 }
}
output "linux_virtual_machine_scale_sets_source_image_reference" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => one(v.source_image_reference) if v.source_image_reference != null && length(v.source_image_reference) > 0 }
}
output "linux_virtual_machine_scale_sets_spot_restore" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => one(v.spot_restore) if v.spot_restore != null && length(v.spot_restore) > 0 }
}
output "linux_virtual_machine_scale_sets_tags" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.tags if v.tags != null && length(v.tags) > 0 }
}
output "linux_virtual_machine_scale_sets_termination_notification" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => one(v.termination_notification) if v.termination_notification != null && length(v.termination_notification) > 0 }
}
output "linux_virtual_machine_scale_sets_unique_id" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.unique_id if v.unique_id != null && length(v.unique_id) > 0 }
}
output "linux_virtual_machine_scale_sets_upgrade_mode" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.upgrade_mode if v.upgrade_mode != null && length(v.upgrade_mode) > 0 }
}
output "linux_virtual_machine_scale_sets_user_data" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.user_data if v.user_data != null && length(v.user_data) > 0 }
}
output "linux_virtual_machine_scale_sets_vtpm_enabled" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.vtpm_enabled if v.vtpm_enabled != null }
}
output "linux_virtual_machine_scale_sets_zone_balance" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.zone_balance if v.zone_balance != null }
}
output "linux_virtual_machine_scale_sets_zones" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.zones if v.zones != null && length(v.zones) > 0 }
}
