...
output "linux_virtual_machine_scale_sets_additional_capabilities" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.additional_capabilities if v.additional_capabilities != null && length(v.additional_capabilities) > 0 }
}
...
output "linux_virtual_machine_scale_sets_automatic_instance_repair" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.automatic_instance_repair if v.automatic_instance_repair != null && length(v.automatic_instance_repair) > 0 }
}
output "linux_virtual_machine_scale_sets_automatic_os_upgrade_policy" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.automatic_os_upgrade_policy if v.automatic_os_upgrade_policy != null && length(v.automatic_os_upgrade_policy) > 0 }
}
output "linux_virtual_machine_scale_sets_boot_diagnostics" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.boot_diagnostics if v.boot_diagnostics != null && length(v.boot_diagnostics) > 0 }
}
...
output "linux_virtual_machine_scale_sets_identity" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.identity if v.identity != null && length(v.identity) > 0 }
}
...
output "linux_virtual_machine_scale_sets_os_disk" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.os_disk if v.os_disk != null && length(v.os_disk) > 0 }
}
...
output "linux_virtual_machine_scale_sets_plan" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.plan if v.plan != null && length(v.plan) > 0 }
}
...
output "linux_virtual_machine_scale_sets_rolling_upgrade_policy" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.rolling_upgrade_policy if v.rolling_upgrade_policy != null && length(v.rolling_upgrade_policy) > 0 }
}
output "linux_virtual_machine_scale_sets_scale_in" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.scale_in if v.scale_in != null && length(v.scale_in) > 0 }
}
...
output "linux_virtual_machine_scale_sets_source_image_reference" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.source_image_reference if v.source_image_reference != null && length(v.source_image_reference) > 0 }
}
output "linux_virtual_machine_scale_sets_spot_restore" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.spot_restore if v.spot_restore != null && length(v.spot_restore) > 0 }
}
...
output "linux_virtual_machine_scale_sets_termination_notification" {
  ...
  value       = { for k, v in azurerm_linux_virtual_machine_scale_set.linux_virtual_machine_scale_sets : k => v.termination_notification if v.termination_notification != null && length(v.termination_notification) > 0 }
}
